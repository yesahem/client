...
export default function Product() {
    return(
        <>
            ...
            <section className="hidden relative w-screen h-[70vh] md:flex flex-col px-12 overflow-hidden sm:block">
                    <Image src={"/info-vector-svg.svg"} width={1500} height={700} alt="image" className="absolute z-10 mt-12 ml-24"/>
                    <NavBar/>
                    <div className="z-20 flex gap-4 w-full h-[89%] px-4 md:gap-2 md:px-1">
                        <div className="w-[70%] h-full flex flex-col justify-center">
                            <h2 className="text-[#005ab1] xl:text-4xl xl:font-bold xl:ml-20 md:text-lg md:font-bold md:ml-12">Discover Tools</h2>
                            <h2 className="text-[#005ab1] xl:text-4xl xl:font-bold xl:ml-20 md:text-lg md:font-bold md:ml-12">That Redefine Vision Care</h2>
                            <p className="w-[67%] xl:ml-20 xl:mt-4 xl:text-[1rem] md:ml-12 md:mt-2 md:text-xs">
                        ...
                        <div>
                            <Image src={"/hero-section-boy-girl-svg.svg"} width={500} height={500} alt="image" className="z-20 mt-20"/>
                        </div>
                    </div>
            </section>   
            <section className="hidden w-full h-[210vh] xl:px-8 md:px-2 md:flex flex-col md:ml-2 sm:block">
                <div className="w-full h-[50%] bg-blue-100 rounded-xl overflow-hidden grid grid-cols-3 xl:gap-1 md:gap-0.5 md:h-[40%]">
                    <div className="flex flex-col xl:pl-12 md:pl-4">
                        <h3 className="text-[#005ab1] xl:text-lg xl:font-medium xl:mt-6 md:mt-12 md:text-lg">Products | Doctors</h3>
                        ...
                        <p className="xl:w-[53%] xl:text-sm xl:mt-4 md:text-xs md:w-[61%]">Jorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus.</p>
                        <Image src={"/Standing Doctor.svg"} width={330} height={300} alt="standing doctor" className="ml-4 mt-20 transform -translate-y-0.5 max-w-330 max-h-200 h-auto w-full md:mt-36"/>
                    </div>
                ...
                <div className="w-full h-[50%] flex gap-4 mt-4 rounded-xl">
                    <div className="w-[65%] rounded-xl relative overflow-hidden bg-blue-100">
                        <h3 className="text-[#005ab1] font-medium mt-6 ml-10 md:mt-4 md:text-lg md:ml-4">Products | Patient</h3>
                        ...
                        <div className="flex bg-white rounded-xl w-[90%] h-[45%] ml-10 mt-4 md:ml-6">
                            <div className="w-[50%] flex flex-col px-4">
                                <div className="ml-6 mt-4 md:ml-2 md:mt-2">
                                    ...
                                    <Image src={"/share.svg"} width={20} height={20} alt="image" className="hidden md:block md:ml-2"/>
                                </div>
                                ...
                                <ul className="ml-6 mt-4 md:text-[0.6rem] md:mt-1 xl:ml-7">
                                    {ProductPatientsData.map((items,index)=>(<ProductPatientsList key={index} {...items}/>))}
                                </ul>
                                <div className="flex gap-4 ml-6 mt-4">
                                    <button className="w-fit-content xl:px-8 xl:py-2 md:px-2 md:py-2 md:text-xs border border-[#005ab1] text-[#005ab1] rounded-lg">Learn More</button>
                                    <button className="w-fit-content xl:px-8 xl:py-2 md:px-2 md:py-2 md:text-xs bg-[#005ab1] text-white rounded-lg">Explore Now</button>
                                </div>                                
                            </div>
                            <div className="w-[50%]">
                                ...
                                <Image src={"/info-manage-appointement-back.svg"} width={180} height={180} alt="image" className="hidden z-10 md:block md:mt-20 md:ml-6"/>
                                <Image src={"/main-section-high-z-index.svg"} width={180} height={180} alt="image" className="hidden z-20 md:block md:-mt-16 md:ml-1"/>
                            </div>
                        </div>
                        <div className="flex flex-col justify-center gap-4 xl:mt-8 md:mt-4 xl:ml-6 md:ml-6 bg-black rounded-xl w-[90%] h-[15%]">
                            <h3 className="text-white xl:text-lg md:text-md md:transform md:-translate-y-4 font-medium ml-6 md:ml-4">With VR Intergation</h3>
                            <h3 className="xl:text-xs md:text-[0.7rem] md:-mt-6 text-white ml-6 md:ml-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie.</h3>
                        </div>
                        <div className="w-full absolute transform -translate-y-[72%] translate-x-[75%] md:translate-x-[60%]">
                            ...
                            <Image src={"/standing-girl.svg"} width={300} height={300} alt="image" className="hidden md:block xl:mt-32 ml-14"/>
                        </div>
                    </div>
                    <div className="w-[33%] bg-black rounded-xl p-12">
                        <div className="h-full w-full rounded-xl flex flex-col">
                            <h3 className="ml-2 text-white md:text-lg xl:text-3xl">Vr Integrations</h3>
                            <p className="ml-2 text-white w-full text-xs mt-4 md:text-[0.5rem] xl:text-[0.9rem]">Jorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus.</p>
                            <ul className="ml-6 mt-4 text-white md:text-xs">
                                {ProductPatientsData.map((items,index)=>(<VrIntegrationList key={index} {...items}/>))}
                            </ul>
                            <Image src={"/vr-integration.svg"} width={250} height={250} alt="image" className="ml-20 mt-12 md:ml-2 xl:ml-16"/>
            ...
            <section className="hidden relative max-w-screen h-[60vh] sm:flex ml-12 mt-12 overflow-hidden"> 
            ...
            <hr className="hidden h-0.5 border-none bg-gradient-to-r from-sky-400 to-cyan-200 w-[80%] px-12 xl:ml-20 md:ml-6 transform translate-y-28 translate-x-16 md:translate-y-8 opacity-60 rounded-xl sm:block"/>
