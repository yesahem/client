  ...
  return (
    <>
      ...
      <div className="z-20 w-full h-full flex flex-col items-center pt-8">
        ...
        <p className="font-semibold mt-2 ml-6 text-center">
        ...
        <div className="hidden lg:block mt-12">
          <Image src="/boy-girl-table.svg" width={500} height={500} alt="boy-girl-table" className="z-20" />
        </div>

        {/* Images for Smaller Screens */}
        <div className="lg:hidden mt-12">
          <Image src="/boy-girl-table.svg" width={400} height={400} alt="boy-girl-table" className="z-20" />
        </div>

        {/* Info Cards Section */}
        <div className="z-30 absolute xl:left-[18%] top-[27%] lg:left-[13%] md:left-[10%]">
          {InfoCardsData.slice(0, 4).map((item, index) => (
            <InfoCards key={index} {...item} />
          ))}

          {/* Frame Images for Smaller Screens */}
          <div className="absolute hidden md:block lg:hidden">
            <Image src="/Frame 1000014222.svg" width={50} height={50} alt="practo" className="absolute top-0 -left-[20%]" />
            <Image src="/Frame 1000014226.svg" width={70} height={70} alt="practo" className="absolute top-[28%] -left-[30%]" />
            <Image src="/Frame 1000014223.svg" width={60} height={60} alt="practo" className="absolute top-[55%] -left-[20%]" />
            <Image src="/Frame 1000014230.svg" width={60} height={60} alt="practo" className="absolute top-[90%] left-[10%]" />
          </div>

          {/* Frame Images for Larger Screens */}
        ...
        {/* Second Set of Info Cards */}
        <div className="z-30 absolute xl:left-[65%] top-[25%] lg:left-[70%] md:left-[70%]">
          {InfoCardsData.slice(4).map((item, index) => (
            <InfoCards key={index} {...item} />
          ))}

          {/* Frame Images for Smaller Screens */}
          <div className="absolute hidden md:block lg:hidden">
            <Image src="/Frame 1000014221.svg" width={50} height={50} alt="practo" className="absolute -top-[5%] left-[90%]" />
            <Image src="/Frame 1000014228.svg" width={70} height={70} alt="practo" className="absolute top-[20%] left-[93%]" />
            <Image src="/Frame 1000014229.svg" width={100} height={100} alt="practo" className="absolute top-[45%] left-[75%]" />
            <Image src="/Frame 1000014225.svg" width={90} height={90} alt="practo" className="absolute top-[65%] left-[85%]" />
            <Image src="/Frame 1000014227.svg" width={100} height={100} alt="practo" className="absolute top-[86%] left-[87%]" />
          </div>
        ...
        {/* Toggle Feature (Orbsway vs Clunky Systems) */}
        <div className="z-30 mt-14 flex items-center justify-center">
        ...
        {/* Call to Action */}
        <h3 className="z-30 text-black ml-2 font-bold mt-4">
          Remember this? Clunky systems and paperwork maze — All before Orbsway stepped in.
        </h3>
        <button className="z-30 bg-[#005ab1] text-center text-white p-2 rounded-lg font-semibold mt-6 hover:bg-[#003c7d] transition-all duration-200">
