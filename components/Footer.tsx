    ...
    return(
        <footer className="h-[30vh] w-full flex justify-center transform -translate-y-1/4">
            <div className="grid grid-cols-4 w-[90%] gap-2">
                ...
                <Image src={"/footer-logo.svg"} width={100} height={100} alt="image"  className=" xl:hidden"/>
                </div>
                <div className=" w-[90%] flex flex-col justify-center items-center">
                <p className="mt-6 ml-6 md:text-xs ">
                    <span className="xl:font-medium md:text-sm">
                ...
                <div className="grid grid-cols-5 w-full gap-1 px-8 md:px-2 mt-2">
